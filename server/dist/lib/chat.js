...
var onPrivateConversation = exports.onPrivateConversation = function () {
  var _ref2 = _asyncToGenerator(regeneratorRuntime.mark(function _callee3(data, socket) {
    var id, decoded_token, _ref3, _ref4, from, to, chats, theChat, chat, users, messages;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 14:
            ...
            theChat.users.forEach(function (u) {
              return console.log(u.dataValues.email);
            });
...
var onDeleteConversation = exports.onDeleteConversation = function () {
  var _ref6 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4(_ref7, io, connectedUsers) {
  ...
  return function onDeleteConversation(_x6, _x7, _x8) {
